...
import cn.sdu.online.findteam.aliwukong.imkit.chat.viewholder.AudioReceiveViewHolder;
...
public class AudioReceiveMessage extends ReceiveMessage implements ItemClick.OnItemClickListener{
    ...
    public void showChatMessage(Context context, ViewHolder holder) {
        ...
        displayAudioContent(context, (AudioReceiveViewHolder) holder);
    }
     ...
     * @param viewHolder
     */
    private void displayAudioContent(final Context context,final AudioReceiveViewHolder viewHolder) {
