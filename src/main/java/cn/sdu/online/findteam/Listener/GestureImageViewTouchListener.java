...
import cn.sdu.online.findteam.util.FlingAnimation;
import cn.sdu.online.findteam.util.MathUtils;
import cn.sdu.online.findteam.util.MoveAnimation;
import cn.sdu.online.findteam.util.VectorF;
import cn.sdu.online.findteam.util.ZoomAnimation;
...
public class GestureImageViewTouchListener implements OnTouchListener {
    ...
    public void setFitScaleVertical(float fitScaleVertical) {
